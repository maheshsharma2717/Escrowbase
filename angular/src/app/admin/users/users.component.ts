...
import { ResetUserPasswordModalComponent } from './rest-user-password/rest-user-password-modal.component';
...
export class UsersComponent extends AppComponentBase implements AfterViewInit {
    ...
    @ViewChild('dynamicParametersModal', { static: true }) dynamicParametersModal: ManageValuesModalComponent;
    @ViewChild('resetUserPasswordModal',{static:true}) resetUserPasswordModal : ResetUserPasswordModalComponent;
    ...
    showDynamicParameters(user: UserListDto): void {
        this.dynamicParametersModal.show('SR.EscrowBaseWeb.Authorization.Users.User', user.id.toString());
    }
