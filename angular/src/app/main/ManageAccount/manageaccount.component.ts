...
import { ManageLinkedAccountService } from '@app/main/ManageAccount/manageaccount.service';
...
export class ManageLinkedAccountsModalComponent extends AppComponentBase {
    ...
    constructor(
        ...
        private _linkedAccountService: ManageLinkedAccountService
    ) {
        super(injector);
    }
    // ngOnInit(): void {
    //     this.getLinkedUsers;
    //     this.getShownLinkedUserName;
    //     this.deleteLinkedUser;
    //     this.manageLinkedAccounts;
    // }
