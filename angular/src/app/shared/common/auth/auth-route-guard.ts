...
userid = '';
    ...
    selectBestRoute(): string {
        ...
        if (this._permissionChecker.isGranted('Pages.SrFileMappings') && this._sessionService.user.id != 1) {
        ...
        if (this._permissionChecker.isGranted('Pages.Tenants')) {
           ...
           if (this._permissionChecker.isGranted('Pages.Tenant.Dashboard') && this._sessionService.user.id != 1 ) {
