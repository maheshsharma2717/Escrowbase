...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.EscrowFileHistoriesServiceProxy,
        ApiServiceProxies.SrAssignedFilesDetailsServiceProxy,
        ApiServiceProxies.SrEscrowFileRemindersServiceProxy,
        ApiServiceProxies.SREscrowFileMastersServiceProxy,
        ApiServiceProxies.EscrowDirectMessageDetailsesServiceProxy,
        ApiServiceProxies.EscrowUserNotesesServiceProxy,
        ApiServiceProxies.EscrowFileTagsesServiceProxy,
        ApiServiceProxies.DocuSignServiceProxy,
