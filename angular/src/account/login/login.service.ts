...
//var myWindow = window.open(initialUrl, "myTab_" + Date.now());
      ...
      openNewTab() {
       ...
       var mytab = window.open("https://www.escrowbaseweb.com/app/main/Userdashboard","_self",);
        if (!this.checkForDuplicateTab()) {
            mytab.location.href = "https://www.escrowbaseweb.com/app/main/Userdashboard","_self";
        }
