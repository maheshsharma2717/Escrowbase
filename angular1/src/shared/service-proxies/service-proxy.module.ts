...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.EnterprisesServiceProxy,
        ApiServiceProxies.SecurityQuestionsServiceProxy,
        ApiServiceProxies.UserAnswersServiceProxy,
        ApiServiceProxies.EscrowClientsServiceProxy,
        ApiServiceProxies.EscrowDetailsServiceProxy,
        ApiServiceProxies.UserFileLogsServiceProxy,
        ApiServiceProxies.SrEscrowsServiceProxy,
