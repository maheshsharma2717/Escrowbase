        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'srEscrowClient/escrowClients', component: EscrowClientsComponent, data: { permission: 'Pages.Administration.EscrowClients' }  },
                    { path: 'srEscrowClient/escrowClients/createOrEdit', component: CreateOrEditEscrowClientComponent, data: { permission: 'Pages.Administration.EscrowClients.Create' }  },
                    { path: 'srEscrowClient/escrowClients/view', component: ViewEscrowClientComponent, data: { permission: 'Pages.Administration.EscrowClients' }  },
