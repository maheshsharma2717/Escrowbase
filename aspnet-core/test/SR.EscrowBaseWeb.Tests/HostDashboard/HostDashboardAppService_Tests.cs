...
using SR.EscrowBaseWeb.MultiTenancy.HostDashboard;
...
namespace SR.EscrowBaseWeb.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(EscrowBaseWebDbContext context, SubscriptionPayment subscriptionPayment)
        {
