...
namespace SR.EscrowBaseWeb.Web.Models.ZohoESign
{
    public class GetFileStatus
    {
        ...
        public RequestFileStatus requests { get; set; }
        public string message { get; set; }
        public string status { get; set; }
    }

    // Root myDeserializedClass = JsonConvert.DeserializeObject<Root>(myJsonResponse);
    public class ActionFileStatus
    {
        ...
        public List<FieldFileStatus> fieldFileStatus { get; set; }
    ...
    public class DocumentIdFileStatus
    {
        public string image_string { get; set; }
        public string document_name { get; set; }
        public List<PageFileStatus> pageFileStatus { get; set; }
    ...
    public class RequestFileStatus
    {
        ...
        public List<DocumentIdFileStatus> documentIdFileStatus { get; set; }
        public bool self_sign { get; set; }
        public List<DocumentFileStatus> documentFileStatus { get; set; }
        ...
        public List<ActionFileStatus> actionFileStatus { get; set; }
