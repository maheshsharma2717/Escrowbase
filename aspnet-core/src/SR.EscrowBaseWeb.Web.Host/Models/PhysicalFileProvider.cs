    ...
    public class PhysicalFileProvider : PhysicalFileProviderBase
    {
        ...
        public virtual FileManagerResponse GetFiles(string path, bool showHiddenItems, params FileManagerDirectoryContent[] data)
        {
            ...
            try
            {
                ...
                String fullPath = (contentRootPath);
...
//            }
//        }
//        //C:\\codebase\\Latest_aspnetzero\\EscrowBaseWeb_v9\\EscrowBaseWeb\\aspnet-core\\src\\SR.EscrowBaseWeb.Web.Host\\wwwroot\\Common\\Paperless\\0001\\0001\\0002";
