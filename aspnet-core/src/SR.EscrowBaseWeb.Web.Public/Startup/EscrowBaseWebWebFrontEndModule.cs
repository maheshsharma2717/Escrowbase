...
namespace SR.EscrowBaseWeb.Web.Public.Startup
{
    [DependsOn(
        typeof(EscrowBaseWebWebCoreModule)
    )]
    public class EscrowBaseWebWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public EscrowBaseWebWebFrontEndModule(IWebHostEnvironment env, EscrowBaseWebEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(EscrowBaseWebWebFrontEndModule).GetAssembly());
        }
    }
}
