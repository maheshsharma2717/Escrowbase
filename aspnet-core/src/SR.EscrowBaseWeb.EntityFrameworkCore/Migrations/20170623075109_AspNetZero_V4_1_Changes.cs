...
namespace SR.EscrowBaseWeb.Migrations
{
   ...
   //    @"ALTER TABLE `AbpRoleClaims` DROP FOREIGN KEY `FK_AbpRoleClaims_AbpRoles_UserId`;",
   //    suppressTransaction: true // MySQL requires this for schema changes
   //);
  ...
  //          migrationBuilder.Sql(
  //    @"DROP INDEX IF EXISTS `IX_AbpRoleClaims_UserId` ON `AbpRoleClaims`;",
  //    suppressTransaction: true // MySQL may require this for schema changes
  //);
