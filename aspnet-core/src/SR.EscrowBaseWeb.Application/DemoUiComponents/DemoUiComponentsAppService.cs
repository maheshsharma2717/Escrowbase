...
using SR.EscrowBaseWeb.DemoUiComponents.Dto;

namespace SR.EscrowBaseWeb.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : EscrowBaseWebAppServiceBase, IDemoUiComponentsAppService
    {
