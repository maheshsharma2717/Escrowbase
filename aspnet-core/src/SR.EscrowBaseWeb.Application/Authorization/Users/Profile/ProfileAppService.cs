...
using SR.EscrowBaseWeb.Authorization.Users.Profile.Cache;
...
using SR.EscrowBaseWeb.Gdpr;
using SR.EscrowBaseWeb.Net.Sms;
using SR.EscrowBaseWeb.Security;
using SR.EscrowBaseWeb.Storage;
using SR.EscrowBaseWeb.Timing;

namespace SR.EscrowBaseWeb.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : EscrowBaseWebAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("SR.EscrowBaseWeb",
