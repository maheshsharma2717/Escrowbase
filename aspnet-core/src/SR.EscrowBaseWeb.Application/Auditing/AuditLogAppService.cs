...
using SR.EscrowBaseWeb.Auditing.Exporting;
using SR.EscrowBaseWeb.Authorization;
using SR.EscrowBaseWeb.Authorization.Users;
using SR.EscrowBaseWeb.Dto;
using SR.EscrowBaseWeb.EntityHistory;
using EntityHistoryHelper = SR.EscrowBaseWeb.EntityHistory.EntityHistoryHelper;

namespace SR.EscrowBaseWeb.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : EscrowBaseWebAppServiceBase, IAuditLogAppService
    {
