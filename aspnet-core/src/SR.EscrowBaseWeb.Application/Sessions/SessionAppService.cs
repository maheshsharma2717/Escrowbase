...
using SR.EscrowBaseWeb.UiCustomization;
...
{
    public class SessionAppService : EscrowBaseWebAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = EscrowBaseWebConsts.Currency,
                    CurrencySign = EscrowBaseWebConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = EscrowBaseWebConsts.AllowTenantsToChangeEmailSettings,
