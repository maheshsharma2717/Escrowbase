...
using SR.EscrowBaseWeb.Migrations.Seed.Host;
...
namespace SR.EscrowBaseWeb.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : EscrowBaseWebAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<EscrowBaseWebDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{EscrowBaseWebConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{EscrowBaseWebConsts.ConnectionStringName}", constring);
        }
