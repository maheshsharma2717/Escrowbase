...
using SR.EscrowBaseWeb.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace SR.EscrowBaseWeb.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : EscrowBaseWebAppServiceBase, IDashboardCustomizationAppService
    {
