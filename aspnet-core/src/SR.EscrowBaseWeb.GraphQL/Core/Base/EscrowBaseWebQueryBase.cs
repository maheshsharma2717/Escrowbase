...
namespace SR.EscrowBaseWeb.Core.Base
{
    public abstract class EscrowBaseWebQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected EscrowBaseWebQueryBase(string fieldName,
