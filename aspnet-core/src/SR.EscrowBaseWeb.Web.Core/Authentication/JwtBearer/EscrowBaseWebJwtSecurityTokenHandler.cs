...
namespace SR.EscrowBaseWeb.Web.Authentication.JwtBearer
{
    public class EscrowBaseWebJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public EscrowBaseWebJwtSecurityTokenHandler()
        {
