...
using SR.EscrowBaseWeb.Authentication.TwoFactor.Google;
...
using SR.EscrowBaseWeb.Web.Models.TokenAuth;
using SR.EscrowBaseWeb.Authorization.Impersonation;
using SR.EscrowBaseWeb.Authorization.Roles;
using SR.EscrowBaseWeb.Configuration;
using SR.EscrowBaseWeb.Debugging;
using SR.EscrowBaseWeb.Identity;
using SR.EscrowBaseWeb.Net.Sms;
...
namespace SR.EscrowBaseWeb.Web.Controllers
{
    ...
    public class TokenAuthController : EscrowBaseWebControllerBase
    {
        ...
        ///<Summary>
        /// Get all required data for token auth's controller
        ///</Summary>
        ...
        ///<Summary>
        /// Delegated impersonated authenticate
        ///</Summary>
        [HttpPost]
        ...
        public async Task<Usertokenn> AuthenticateByEmail(string username,string password)
        {
            ...
            {
                loginResult.User.SetNewPasswordResetCode();
                Usertokenn obj = new Usertokenn();
                obj.resetpasswordtoken = loginResult.User.PasswordResetCode;
                obj.userid = loginResult.User.Id;
                return obj;
            }
            return null;
        }
    ...
    /// User token class
    ///</Summary>
    public class Usertokenn
    {
        ///<Summary>
        /// Parameter resetpasswordtoken
        ///</Summary>
