...
using SR.EscrowBaseWeb.MultiTenancy.Demo;
...
namespace SR.EscrowBaseWeb.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(EscrowBaseWebConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(EscrowBaseWebConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
