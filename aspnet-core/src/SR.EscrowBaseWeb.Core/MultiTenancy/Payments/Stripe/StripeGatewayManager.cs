...
{
    public class StripeGatewayManager : EscrowBaseWebServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "EscrowBaseWeb";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + EscrowBaseWebConsts.Currency;
        }
