...
namespace SR.EscrowBaseWeb.Notifications
{
    public class AppNotifier : EscrowBaseWebDomainServiceBase, IAppNotifier
    {
        ...
        {
            //var notificationData = new CustomMessageNotificationDataWrapper(message);
            await _notificationPublisher.PublishAsync(
