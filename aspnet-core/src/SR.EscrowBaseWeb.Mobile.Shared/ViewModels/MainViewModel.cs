...
using SR.EscrowBaseWeb.Commands;
...
using SR.EscrowBaseWeb.Controls;
using SR.EscrowBaseWeb.Dto;
using SR.EscrowBaseWeb.Extensions;
using SR.EscrowBaseWeb.Localization;
using SR.EscrowBaseWeb.UI;
using SR.EscrowBaseWeb.UI.Assets;
using SR.EscrowBaseWeb.Views;
using DependencyResolver = SR.EscrowBaseWeb.Core.Dependency.DependencyResolver;

namespace SR.EscrowBaseWeb.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "EscrowBaseWeb";
