...
$webMvcFolder = Join-Path $slnFolder "src/SR.EscrowBaseWeb.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/SR.EscrowBaseWeb.Web.Public"
...
dotnet restore SR.EscrowBaseWeb.Web.sln
